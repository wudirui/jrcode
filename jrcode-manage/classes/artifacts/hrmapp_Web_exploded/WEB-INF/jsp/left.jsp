    ...
    <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
        ...
        <tr>
            <td id="navbg1" class="left_nav_closed">
                <div class="font1">年级管理</div>
            </td>
        </tr>
        <tr valign="top" id="submenu1" style="display: none">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="dept/selectDept" target="main">年级查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="dept/addDept?flag=1" target="main">添加年级</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr valign="top" id="submenu2" style="display: none">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/selectJob"
                                                                                                    target="main">学历查询</a></img>
                </p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="job/addJob?flag=1" target="main">添加学历</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr>
            <td id="navbg3" class="left_nav_closed">
                <div class="font1">学生管理</div>
            </td>
        </tr>
        <tr valign="top" id="submenu3" style="display: none">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/employee/selectEmployee" target="main">学生查询</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/employee/addEmployee?flag=1" target="main">添加学生</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr>
            <td id="navbg6" class="left_nav_closed" onClick="showsubmenu(5)">
                <div class="font1">轮播图管理</div>
            </td>
        </tr>
        <tr valign="top" id="submenu6" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/slideshow/selectSlideshow" target="main">轮播图查询</a></img></p>

                <%--<p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a--%>
                        <%--href="${ctx }/slideshow/sortSlideshow?flag=1" target="main">轮播图排序</a></img></p>--%>

                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="${ctx }/slideshow/addSlideshow?flag=1" target="main">上传轮播图</a></img></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
        ...
        <tr valign="top">
            <td height="100%" align="center">
                <div class="copycct"><br/><strong>jrcode：</strong><br><strong>北京理工大学光机电一体化实验室</strong><br>Http://www.bit.jrcode.com
                </div>
            </td>
        </tr>
        <tr>
