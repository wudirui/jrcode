...
//		System.out.println("HrmServiceImpl login -- >>");
	...
	public List<Notice> findNotice(Notice notice, PageModel pageModel) {
		...
		if (notice != null && notice.getMenuId() != null && notice.getMenuId() == 0) {
			notice.setMenuId(null);
		}
	...
	public void saveSlideshow(Slideshow slideshow) {
		slideshowDao.saveSlideshow(slideshow);
	}

	@Override
	public List<Slideshow> findSlideshow(Menu menu, PageModel pageModel) {
		Map<String, Object> params = new HashMap<>();
		params.put("menu", menu);
		if (menu != null && menu.getId() != null && menu.getId() == 0) {
			menu.setId(null);
		}
		int recordCount = slideshowDao.count(params);
		pageModel.setRecordCount(recordCount);
		...
		return slideshowDao.findSlideshow(params);
	}
	...
	@Override
	public void removeSlideshowById(Integer i) {
		slideshowDao.deleteById(i);
	}

	@Override
	public void sortSlideshow(Slideshow slideshow) {
		slideshowDao.sortSlideshow(slideshow);
	}
}
