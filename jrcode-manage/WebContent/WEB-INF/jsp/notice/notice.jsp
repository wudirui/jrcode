...
<head>
    ...
    <link href="${ctx}/css/pager.css" type="text/css" charset="UTF-8" rel="stylesheet"/>
    <style type="text/css">
        #id_content td:nth-of-type(3) img {
            display: none;
        }
    </style>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    ...
    <tr valign="top">
        <td height="20">
            <table id="id_content" width="100%" border="1" cellpadding="5" cellspacing="0"
